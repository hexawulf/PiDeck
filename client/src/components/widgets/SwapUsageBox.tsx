...
export function SwapUsageBox() {
  ...
  return (
    <div className="rounded-2xl border p-4 shadow bg-pi-card text-pi-text w-full">
      ...
      {isLoading ? (
        <p className="text-pi-text-muted">Loading swap data...</p>
      ) : error ? (
        <div className="text-sm">
          <p className="text-pi-warning mb-2">Swap data temporarily unavailable</p>
        ...
        <div className="text-sm space-y-1">
          ...
          <p>Used: <span className={swapData.used > 0 ? 'text-pi-warning' : ''}>{swapData.used}MB</span></p>
